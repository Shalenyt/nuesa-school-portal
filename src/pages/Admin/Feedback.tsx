...
import { MessageSquare, Trash2, User, EyeOff } from 'lucide-react';
...
export default function AdminFeedback() {
  ...
  const fetchFeedback = async () => {
    ...
    // Fetch sender profiles for non-anonymous
                  ...
                  <div className="flex-1 min-w-0 space-y-1">
                    ...
                    <div className="flex items-center gap-2 text-xs text-muted-foreground pt-1">
                      {f.is_anonymous ? (
                        ...
                        <span className="flex items-center gap-1"><User className="h-3 w-3" /> {sender.full_name} ({sender.email})</span>
                      ) : (
